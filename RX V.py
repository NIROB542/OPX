...
for ua in range(5000):
    ...
    ugen.append(uaku2)
os.system("espeak \"well come,to RX NIROB, HACKR, Tools\"")
logo = (f"""
...
\033[1;31m[\033[1;32m•\033[1;31m]\33[1;32m 𝐉𝐀𝐕𝐀 & 𝐂𝐄𝐎   : RX NIROB - VAI 
...
def TANJID():
    os.system('clear')
    os.system('xdg-open https://m.me/j/AbZmKAI0S5go0h7Q/')
    print(logo)
